 ...
 * Template Name: Media
 *
 * Generated from Maneesh/gallary-1.html.
 *
 * @package Interior
 */
            ...
            <div class="container">
                <div class="gallary-item-wrap-inner">
                    <div class="gallary-item-inner">
                        <a href="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-1.png' ); ?>" class="venobox" data-gall="gallary1"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-1.png' ); ?>" alt="img"></a>
                        <h4 class="title">Bathroom Bliss</h4>
                    </div>
                    <div class="gallary-item-inner">
                        <a href="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-2.png' ); ?>" class="venobox" data-gall="gallary1"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-2.png' ); ?>" alt="img"></a>
                        <h4 class="title">Living Room Stories</h4>
                    </div>
                    <div class="gallary-item-inner">
                        <a href="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-3.png' ); ?>" class="venobox" data-gall="gallary1"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-3.png' ); ?>" alt="img"></a>
                        <h4 class="title">Office Room</h4>
                    </div>
                    <div class="gallary-item-inner">
                        <a href="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-4.png' ); ?>" class="venobox" data-gall="gallary1"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-4.png' ); ?>" alt="img"></a>
                        <h4 class="title">Elegant Dining Spaces</h4>
                    </div>
                    <div class="gallary-item-inner">
                        <a href="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-5.png' ); ?>" class="venobox" data-gall="gallary1"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/project/gallary-img-5.png' ); ?>" alt="img"></a>
