		...
		<section class="page-header">
			...
			<div class="container">
				<div class="page-header-content">
					<h1 class="title"><?php esc_html_e( 'Projects', 'interior' ); ?></h1>
					<h4 class="sub-title"><a class="home" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'interior' ); ?> </a><span class="icon">-</span><a class="inner-page" href="<?php echo esc_url( get_permalink() ); ?>"> <?php esc_html_e( 'Projects', 'interior' ); ?></a></h4>
				</div>
			</div>
		</section>
				...
				<div class="row gy-5">
					<?php if ( $projects->have_posts() ) : ?>
						...
						while ( $projects->have_posts() ) :
							...
							$detail_url = add_query_arg( 'project_id', get_the_ID(), $detail_page_url );
							?>
							<div class="col-lg-4 col-md-6">
								<div class="service-item-3 antra-hover-view">
									<div class="service-thumb">
										...
										<span class="number"><?php echo esc_html( str_pad( $order ? $order : $projects->current_post + 1, 2, '0', STR_PAD_LEFT ) ); ?></span>
									</div>
