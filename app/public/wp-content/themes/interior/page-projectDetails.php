 ...
 *
 * Generated from Maneesh/service-details.html.
 *
 * @package Interior
 */
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="service-details-left-content pin-box">
                            ...
                            <div class="service-details-cta">
                                ...
                                <a class="mail" href="mailto:">support@example.com</a>
                                <div class="cta-btn">
                                    <a href="contact.html">Get a call <br> Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-12">
                        <div class="service-details-content scroll-content">
                            <div class="service-details-img">
                                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/service/service-details-img-1.png' ); ?>" alt="img">
                            </div>
                            ...
                            <div class="service-details-items">
                                <div class="service-details-item">
                                    <div class="icon"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/icon/service-details-1.png' ); ?>" alt="service"></div>
                                    <div class="content">
                                ...
                                <div class="service-details-item">
                                    <div class="icon"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/icon/service-details-2.png' ); ?>" alt="service"></div>
                                    <div class="content">
                                ...
                                <div class="service-details-item">
                                    <div class="icon"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/icon/service-details-3.png' ); ?>" alt="service"></div>
                                    <div class="content">
                                ...
                                <div class="service-details-item">
                                    <div class="icon"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/icon/service-details-4.png' ); ?>" alt="service"></div>
                                    <div class="content">
                            ...
                            <div class="service-details-img-wrap">
                                <div class="details-img">
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/service/service-details-img-2.png' ); ?>" alt="img">
                                </div>
                                <div class="details-img">
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/service/service-details-img-3.png' ); ?>" alt="img">
                                </div>
                            </div>
